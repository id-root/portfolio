...
const gamjaFlower = Gamja_Flower({ subsets: ["latin"], weight: "400", display: "swap", variable: "--font-gamja" });
...
export default function RootLayout({
    ...
    return (
        <html lang="en" suppressHydrationWarning>
            ...
            <body className={`${dmSans.variable} ${outfit.variable} ${gamjaFlower.variable} ${figtree.variable} font-gamja antialiased bg-background text-text-primary selection:bg-brand-primary selection:text-white overflow-x-hidden`}>
                <PreloaderWrapper>
                    <GlitchProvider>
                        <SmoothScroll>
                            <ElegantBackground />
