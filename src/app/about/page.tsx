            ...
            <main className="relative z-10 w-full">
                ...
                <section className="pt-40 md:pt-48 pb-20 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-[1fr_1fr] gap-16 lg:gap-24 items-start">
                        ...
                        >
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-gamja text-text-primary font-medium tracking-tight leading-[1.05] mb-8">
                                Learning <br/> systems, <br/> building <br/> intelligent defenses.
                            </h1>
                            <div className="h-px w-24 bg-brand-primary/50 mb-8" />
                        ...
                        >
                            {[
                                ...
                                <motion.div key={i} variants={fadeUp} className="group relative pl-6 border-l-2 border-border hover:border-brand-primary transition-colors duration-300">
                                    <span className="absolute -left-[1px] top-0 w-0.5 h-0 bg-brand-primary group-hover:h-full transition-all duration-500 rounded-full" />
                                    <div className="flex items-baseline gap-3 mb-2">
                                        <span className="text-xs font-mono text-brand-primary tracking-wider">{item.num}</span>
