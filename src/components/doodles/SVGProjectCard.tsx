...
export const SVGProjectCard = ({
    ...
    return (
        ...
        >
            ...
            {/* Title */}
            <text x="80" y="165" fontFamily="'Fraunces', serif" fontWeight="700" fontSize="44" fill="#1c1c1c">{title}</text>
            ...
            <rect x={680 + rx} y="60" width="185" height="48" rx="15" fill="#e8e2f8" stroke="#1c1c1c" strokeWidth="3" filter={`url(#sk-${uid})`} />
            <rect x={675 + rx} y="55" width="185" height="48" rx="15" fill="#fdfcfb" stroke="#1c1c1c" strokeWidth="3" filter={`url(#sk-${uid})`} />
            <text x={695 + rx} y="85" fontFamily="'Figtree', sans-serif" fontWeight="600" fontSize="20" fill="#1c1c1c">{status.toUpperCase()}</text>
            ...
            <path d={`M ${590 + rx} 145 C ${610 + rx} 125, ${625 + rx} 155, ${640 + rx} 130 C ${650 + rx} 110, ${660 + rx} 95, ${668 + rx} 82`} fill="none" stroke="#1c1c1c" strokeWidth="2.5" strokeLinecap="round" filter={`url(#sk-${uid})`} />
            <path d={`M ${658 + rx} 87 L ${671 + rx} 80 L ${666 + rx} 94`} fill="none" stroke="#1c1c1c" strokeWidth="2.5" strokeLinecap="round" />
            <path d={`M ${568 + rx} 150 L ${578 + rx} 150 M ${573 + rx} 145 L ${573 + rx} 155`} stroke="#1c1c1c" strokeWidth="1.5" />
                ...
                if (highlightText && line.includes(highlightText)) {
                    ...
                    return (
                        <g key={i}>
                            ...
                            <text x="80" y={240 + i * 40} fontFamily="'Figtree', sans-serif" fontWeight="400" fontSize="24" fill="#1c1c1c">{line}</text>
                        </g>
                    );
                }
                return <text key={i} x="80" y={240 + i * 40} fontFamily="'Figtree', sans-serif" fontWeight="400" fontSize="24" fill="#1c1c1c">{line}</text>;
            })}
            ...
            <rect x="83" y={approachLabelY - 5} width="130" height="35" rx="8" fill="#fdfcfb" stroke="#1c1c1c" strokeWidth="2.5" filter={`url(#sk-${uid})`} />
            <text x="96" y={approachLabelY + 18} fontFamily="'Fraunces', serif" fontWeight="600" fontSize="19" fill="#1c1c1c">APPROACH</text>
            ...
            <rect x="83" y={approachBoxY - 2} width="430" height={approachBoxH} rx="15" fill="#fcf6e5" stroke="#1c1c1c" strokeWidth="1" opacity="0.3" filter={`url(#sk-${uid})`} transform={`rotate(-0.5 300 ${approachBoxY + approachBoxH / 2})`} />

            {/* Approach text */}
            {approachLines.map((line, i) => (
                <text key={i} x="110" y={approachBoxY + 30 + i * 27} fontFamily="'Figtree', sans-serif" fontWeight="400" fontSize="16" fill="#2c2c2c">{line}</text>
            ))}
