        ...
        <section ref={heroRef} className="h-[140vh] relative -mt-24">
            ...
            >
                <div className="relative z-10 w-full max-w-7xl mx-auto pt-20">
                    ...
                    <div className="w-full min-h-[480px] md:min-h-[500px] bg-stone-800 dark:bg-[#0a0908]/95 rounded-[2rem] relative overflow-hidden border border-stone-700/50 dark:border-[#d5c0aa]/10 shadow-[0_20px_60px_rgba(0,0,0,0.3)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.5)] group">
                        <BackgroundSpotlight
                            className="-top-20 left-1/2 -ml-[400px] w-[800px] h-[800px] opacity-40 dark:opacity-20"
                            fill="#C4A77D"
                        />

                        <div className="flex flex-col md:flex-row h-full min-h-[480px] md:min-h-[500px]">
                            {/* Left content */}
                            <div className="flex-1 p-8 md:p-12 lg:p-16 relative z-10 flex flex-col justify-center">
                                ...
                                >
                                    <button
                                        ...
                                        className="group relative px-8 py-3.5 bg-transparent overflow-hidden rounded-full border border-accent-caramel/50 transition-all hover:border-transparent hover:shadow-[0_8px_32px_rgba(196,167,125,0.3)]"
                                    >
                                        <span className="relative z-10 text-white font-outfit uppercase tracking-widest text-xs font-medium group-hover:text-stone-900 transition-colors duration-500">
                                            Explore Work
                                        </span>
